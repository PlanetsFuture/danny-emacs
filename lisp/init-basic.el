...
(when (display-graphic-p)
  ...
  (bind-keys ("C-M-<return>"    . danny-frame-maximize)
             ("C-M-<backspace>" . danny-frame-restore)
             ("C-M-<left>"      . danny-frame-left-half)
             ("C-M-<right>"     . danny-frame-right-half)
             ("C-M-<up>"        . danny-frame-top-half)
             ("C-M-<down>"      . danny-frame-bottom-half)))
